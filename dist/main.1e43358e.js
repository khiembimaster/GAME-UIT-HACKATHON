...
var LoadScene = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  function LoadScene() {
    ...
    return _super.call(this, _CST.CST.SCENES.LOAD);
  }
  _createClass(LoadScene, [{
    ...
    value: function create() {
      this.scene.start(_CST.CST.SCENES.MENU, "Hello Menu");
    }
  }]);
  return LoadScene;
}(Phaser.Scene);
exports.LoadScene = LoadScene;
},{"../CST":"src/CST.js"}],"src/scenes/MenuScene.ts":[function(require,module,exports) {
"use strict";
...
var MenuScene = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  function MenuScene() {
    ...
    return _super.call(this, CST_1.CST.SCENES.MENU);
  }
  _createClass(MenuScene, [{
    ...
    value: function create() {
      ...
      var playButton = this.add.image(this.game.renderer.width / 2, this.game.renderer.height * 0.5, "play_button").setDepth(2);
      var optionButton = this.add.image(this.game.renderer.width / 2, this.game.renderer.height * 0.6, "options_button").setDepth(2);
      //create sprites
      var hoverSprite = this.add.sprite(128, 128, "cat");
...
var _MenuScene = require("./scenes/MenuScene.ts");
...
},{"./scenes/LoadScene.js":"src/scenes/LoadScene.js","./scenes/MenuScene.ts":"src/scenes/MenuScene.ts"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
